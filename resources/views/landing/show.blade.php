    ...
    <section id="hero">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="hero-title">{{ $tefa->nama }}</h1>
                    <p class="hero-subtitle my-4">
                        {{ $tefa->deskripsi }}
                    </p>
                    <a href="{{ route('reservasi.create') }}" class="btn btn-primary me-2">Pelajari Lebih Lanjut</a>
        ...
        <div class="container text-center">
                        ...
                        @if($key < 3)
                            <div class="col-md-4">
                                <div class="card product-card">
                                    <img src="{{ asset('uploads/tefa/produk/' . $tefa->id . '/' . $product->detail) }}" alt="{{ $tefa->nama }}">
                                </div>
                            </div>
                        @endif
            ...
            <div class="mt-5 mb-5 pt-5">
                 ...
                 <div class="gallery-grid">
                    {{-- 
                        Struktur untuk Laravel Blade:
                        Asumsikan Anda memiliki koleksi $galleryImages.
                        Gambar pertama akan menjadi yang terbesar.
                        Gunakan @if($loop->first) untuk item besar dan @else untuk item kecil.
                    --}}

                    {{-- Gambar Besar (Item Pertama dari Loop) --}}
                    @if(isset($tefa->kegiatanTefa[0]))
                        <div class="gallery-item gallery-item-large">
                            <img src="{{ asset('uploads/tefa/kegiatan/' . $tefa->id . '/' . $tefa->kegiatanTefa[0]->detail) }}" alt="Galeri Kegiatan 1">
                        </div>
                    @endif

                    {{-- Gambar Kecil (Sisa item dari loop, skip yang pertama) --}}
                    @foreach($tefa->kegiatanTefa->skip(1) as $key => $image)
                        @if ($key >= 4)
                            @break
                        @endif
                ...
                <div class="row g-4 justify-content-center">
                    @forelse ($tefa->fasilitasTefa as $key => $fasilitas)
                        ...
                        @if($key < 3)
                            <div class="col-md-4">
                                <div class="card product-card">
                                    <img src="{{ asset('uploads/tefa/fasilitas/' . $tefa->id . '/' . $fasilitas->detail) }}" alt="{{ $tefa->nama }}">
                                </div>
                            </div>
                        @endif
