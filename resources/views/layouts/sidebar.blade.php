    ...
    >
      ...
      >
        <ul class="flex flex-col pl-0 mb-0">
          <x-sidebar-item icon="ni ni-tv-2" title="Dashboard" link="#" :color="'text-blue-500'" :isActive="false" />
          <x-sidebar-item icon="ni ni-tv-2" title="Dashboard" link="#" :color="'text-orange-500'" :isActive="true" />
        </ul>
      </div>
</aside>
